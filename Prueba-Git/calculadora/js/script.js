...
document.getElementById("mas").addEventListener("click", o1);
document.getElementById("menos").addEventListener("click", o2);
document.getElementById("por").addEventListener("click", o3);
document.getElementById("div").addEventListener("click", o4);
...
function o1(){
	...
	let actual = document.getElementById('resultado').innerHTML;
	let sumado = document.getElementById("mas").innerHTML;
	document.getElementById('resultado').innerHTML = actual + " " + sumado + " ";
...
function o2(){
	...
	let actual = document.getElementById('resultado').innerHTML;
	let sumado = document.getElementById("menos").innerHTML;
	document.getElementById('resultado').innerHTML =  actual + " " + sumado + " ";
...
function o3(){
	...
	let actual = document.getElementById('resultado').innerHTML;
	let sumado = document.getElementById("por").innerHTML;
	document.getElementById('resultado').innerHTML = actual + " " + sumado + " ";
